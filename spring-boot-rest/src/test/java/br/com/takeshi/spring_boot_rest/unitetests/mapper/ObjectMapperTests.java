...
public class ObjectMapperTests {
    ...
    public void parseEntityListToDTOListTest() {
        List<UserDto> outputList = parseListObject(inputObject.mockEntityList(), UserDto.class);
    ...
    public void parseDTOToEntityTest() {
        UserEntity output = parseObject(inputObject.mockDTO(), UserEntity.class);
        assertEquals(Long.valueOf(0L), output.getId());
        assertEquals("First Name Test0", output.getFirstName());
        assertEquals("Last Name Test0", output.getLastName());
        assertEquals("Address Test0", output.getAddress());
    ...
    public void parserDTOListToEntityListTest() {
        List<UserEntity> outputList = parseListObject(inputObject.mockDTOList(), UserEntity.class);
